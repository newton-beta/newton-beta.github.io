...
background.initializr = function (){
  ...
  $this.style = {bubbles_color:"#fff",stroke_width:0, stroke_color :"black"}; //Change the COLOR of the Objects from #fff to any other...
 ...
 background.generate_bubbles = function() {
   ...
   var res = bolla.transit({top: $this.rn($this.wh/2,$this.wh/2-60), 
